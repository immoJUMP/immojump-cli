...
var GlobalFlags = []Flag{
	...
	{Name: "table", Kind: FlagBool, Desc: "Ausgabe als Tabelle (für Menschen; Env: IMMOJUMP_OUTPUT=table)"},
...
var Registry = []Spec{
	// --- auth -------------------------------------------------------------
	{
		...
		Flags: []Flag{
			...
			{Name: "no-browser", Kind: FlagBool,
				Desc: "Browser nicht öffnen, nur die Adresse der Token-Seite nennen"},
